                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      {poem.subtitle && <div className="text-sm text-gray-500">{poem.subtitle}</div>}
                    </div>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <div className="flex items-center justify-end space-x-2">
                    <button
                      ...
                      className={`p-1 rounded-full ${
                        poem.isListed ? 'text-green-500 hover:bg-green-50' : 'text-gray-400 hover:bg-gray-50'
                      }`}
                    ...
                    <button
                      ...
                      className={`p-1 rounded-full ${
                        poem.isFeatured ? 'text-yellow-500 hover:bg-yellow-50' : 'text-gray-400 hover:bg-gray-50'
                      }`}
